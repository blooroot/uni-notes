...
void pantalla() {
    ...
    gluQuadricDrawStyle(pt, GLU_LINE); // Con GLU_LINE, las figuras serán huecas
    glColor3f (1.0, 0.0, 0.0); // Color de las figuras
    // (radio_interno, radio_externo, n_segments, n_anillos, ang_ini, ang_fin)
...
int main(int argc, char *argv[]) {
    ...
    glutCreateWindow("Hollow Disk"); // La nueva ventana
